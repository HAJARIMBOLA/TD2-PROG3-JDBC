...
public class UnitConverter {
    ...
    private final Map<String, Map<UnitType, Map<UnitType, Double>>> conversions = new HashMap<>();
    ...
    private void add(String ingredient, UnitType from, UnitType to, double factor) {
        conversions
    ...
    public Double convertTo(String ingredientName, UnitType from, UnitType to, Double value) {
        ...
        if (fromMap == null || !fromMap.containsKey(to)) {
            throw new RuntimeException(
                    "Cannot convert from " + from + " to " + to + " for " + ingredientName
            );
        }
